...
#mpirun --mca btl tcp,self -np 16 --hostfile ../conf/hosts matTest2 7000;

#mpirun --mca btl tcp,self -np 16 --hostfile ../conf/hosts matTest2 8000;

#mpirun --mca btl tcp,self -np 16 --hostfile ../conf/hosts matTest2 9000;

#mpirun --mca btl tcp,self -np 16 --hostfile ../conf/hosts matTest2 10000;
